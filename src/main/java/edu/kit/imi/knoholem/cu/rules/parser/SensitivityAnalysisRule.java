 ...
 * antecedent and a consequent. Additionaly, it has a set of properties, as
...
public class SensitivityAnalysisRule {
	...
	void setConsequent(List<Predicate> conclusionPredicates) {
		consequent.addAll(conclusionPredicates);
	}
	
	void setAntecedent(List<Predicate> antecedentPredicates) {
