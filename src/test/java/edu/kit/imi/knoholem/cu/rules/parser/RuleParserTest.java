...
public class RuleParserTest {
    ...
    private static final String ruleLiteral = "IF ZoneID= RC0.13ATRMGRND ^ Weight= 0.00 ^ Type= Tot_Cool_Reduc ^ Reduction= 5.00% ^ 6>= 14.31 ^ 6<= 15.04 THEN Temperature_Set= 16.09";
