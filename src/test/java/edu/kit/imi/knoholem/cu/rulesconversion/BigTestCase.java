...
public class BigTestCase {
	...
	private static final String ontologySource = "D:/Imm/git/Ontology/knoholem-ont-forum-rdf-xml.owl";
	private static final String ontologyTarget = "D:/Imm/git/Ontology/knoholem-ont-forum-rdf-xml-CUTest.owl";
...
//		System.out.println(swrlRule.toString());
	...
	private Properties getDefaultMappingProperties(){
		...
		System.out.println(file == null ? "Mapping properties file not found." : "Mapping properties file found");
		try {
			props.load(file);
