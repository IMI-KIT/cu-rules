...
public class SWRLRuleConverterTest {
	...
	public void testFiltersRepeatingAtoms() {
		...
		expectedAntecedent.add(new ClassAtom("Sensor", new Individual("ZoneID")));
		expectedAntecedent.add(new PropertyAtom("hasAnalogValue", new Individual("ZoneID"), new Unknown("a")));
		expectedAntecedent.add(new PropertyAtom("equal", new Unknown("a"), new Value("ZONE")));
		expectedAntecedent.add(new ClassAtom("Sensor", new Individual("6")));
		expectedAntecedent.add(new PropertyAtom("hasAnalogValue", new Individual("6"), new Unknown("b")));
		expectedAntecedent.add(new PropertyAtom("greaterThanOrEqual", new Unknown("b"), new Value("14.31")));
		expectedAntecedent.add(new PropertyAtom("lessThanOrEqual", new Unknown("b"), new Value("15.04")));
